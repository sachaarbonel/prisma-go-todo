...
type ComplexityRoot struct {
	Mutation struct {
		CreateTodo func(childComplexity int, text string, done *bool) int
	}
...
type MutationResolver interface {
	CreateTodo(ctx context.Context, text string, done *bool) (prisma.Todo, error)
}
type QueryResolver interface {
	Todo(ctx context.Context, id string) (*prisma.Todo, error)
	Todos(ctx context.Context) ([]prisma.Todo, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.createTodo":
		...
		return e.complexity.Mutation.CreateTodo(childComplexity, args["text"].(string), args["done"].(*bool)), true
...
func (ec *executionContext) _Mutation_createTodo(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	resTmp := ec.FieldMiddleware(ctx, nil, func(ctx context.Context) (interface{}, error) {
		return ec.resolvers.Mutation().CreateTodo(ctx, args["text"].(string), args["done"].(*bool))
	})
	if resTmp == nil {
		if !ec.HasError(rctx) {
...
func (ec *executionContext) _Query_todo(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	ctx = graphql.WithResolverContext(ctx, rctx)
	resTmp := ec.FieldMiddleware(ctx, nil, func(ctx context.Context) (interface{}, error) {
		return ec.resolvers.Query().Todo(ctx, args["id"].(string))
	})
	if resTmp == nil {
		return graphql.Null
	}
...
// nolint: vetshadow
func (ec *executionContext) _Todo_id(ctx context.Context, field graphql.CollectedField, obj *prisma.Todo) graphql.Marshaler {
	rctx := &graphql.ResolverContext{
		Object: "Todo",
		Args:   nil,
		Field:  field,
...
// nolint: vetshadow
func (ec *executionContext) _Todo_text(ctx context.Context, field graphql.CollectedField, obj *prisma.Todo) graphql.Marshaler {
	rctx := &graphql.ResolverContext{
		Object: "Todo",
		Args:   nil,
		Field:  field,
...
// nolint: vetshadow
func (ec *executionContext) _Todo_done(ctx context.Context, field graphql.CollectedField, obj *prisma.Todo) graphql.Marshaler {
	rctx := &graphql.ResolverContext{
		Object: "Todo",
		Args:   nil,
		Field:  field,
